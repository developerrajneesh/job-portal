...
import { createJob,getJobCount, deleteJob,unsaveJob,creteSavedJobs,getcompanyjobs,createApplyJobs,creacteRecentJobs, getEmployerCreatedJobs, getJobs, getOneJob, getSavedJobs, removedSaveJob, updateJob } from "../controllers/jobs.controller.js"
...
router.post("/create-recent-jobs", creacteRecentJobs) 
router.get("/", getJobs) 
